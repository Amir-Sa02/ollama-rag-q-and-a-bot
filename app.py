...
# --- Job 4: The User Interface Loop ---
# This block runs the application and allows for an interactive conversation.
if __name__ == '__main__':
    print("--- ربات پرسش و پاسخ محصولات الکترونیکی ---")
    while True:
        user_question = input("\nسوالات خود را درمورد محصولات الکترونیکی ما بپرسید: ")
        if user_question.lower() == 'exit':
            break
        
        print("\n پاسخ مدل:")
        # Call our main RAG function with the user's input.
